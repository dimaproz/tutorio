...
const TONE = {
  ...
  tint: {
    surface: 'bg-tint-indigo text-tint-foreground',
    muted: 'text-tint-indigo-muted',
    track: 'bg-stat-track-on-tint',
    trackStroke: 'stroke-stat-track-on-tint',
    divider: 'border-tint-foreground/10',
    highlight: 'bg-brand',
    highlightStroke: 'stroke-brand',
  },
  accent: {
    surface: 'bg-tint-sky text-tint-foreground',
