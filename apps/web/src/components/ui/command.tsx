...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-10 rounded-control border-0 bg-background">
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "group/command-item relative flex min-h-10 cursor-pointer items-center gap-2 rounded-control px-3 py-2 text-sm font-medium outline-hidden select-none in-data-[slot=dialog-content]:rounded-control data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-selected:bg-surface-hover data-selected:text-foreground data-[checked=true]:bg-surface-hover data-[checked=true]:font-semibold [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 data-selected:*:[svg]:text-foreground",
        className,
      )}
      {...props}
    >
