...
export function StudentPackagesCard({ studentId, createOpen, onCreateOpenChange, readOnly = false, bare = false }: { studentId: string; createOpen: boolean; onCreateOpenChange: (open: boolean) => void; readOnly?: boolean;
  /**
