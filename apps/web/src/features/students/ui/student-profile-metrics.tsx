...
export function StudentProfileMetrics({ student }: { student: StudentDetail }) {
  ...
  // The agreed price belongs next to what has been paid, not in a contacts list.
  const price =
    student.hourlyRateMinor != null && student.currency
      ? formatMoneyDisplay(student.hourlyRateMinor, student.currency, locale)
      : undefined;
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <StatBlock
        ...
        value={PENDING_VALUE}
        caption={t('pending')}
        detail={price ? t('perLesson', { price }) : undefined}
      />
