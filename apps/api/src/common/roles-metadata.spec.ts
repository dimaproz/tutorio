...
const ownerRoutes = new Set([
  ...
  'BillingController.listWarnings',
  'DashboardController.money',
  ...
  'SchedulesController.cancelChange',
  'SchedulesController.cancelStop',
  ...
  'PackagesController.extend',
  'PackagesController.getDetail',
  'PackagesController.getLedger',
  'PackagesController.list',
  'PackagesController.preview',
  'PackagesController.refund',
  'PackagesController.remove',
  'PackagesController.previewMembers',
  'PackagesController.sellToMembers',
  'PackagesController.transfer',
  ...
  'PausesController.create',
  'PausesController.end',
  'PausesController.endPreview',
  'PausesController.get',
  'PausesController.list',
  'PausesController.preview',
  'PausesController.update',
