...
| Current gaps  | Auto-completion at lesson end, per-participant charging and schedule-level student conflicts arrive in later Work Packet 6.4 phases ([`product/scheduling.md`](../product/scheduling.md)). A correction of the original after its makeup was charged is not re-evaluated until the billing phase. |
