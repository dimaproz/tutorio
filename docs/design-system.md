...
| Price of a lesson                        | `PriceField` — `@/components/shared/price-field`                                                                                                                  | `state` amount/locked/package/empty, currency sign, `labelAction` («Повернути ставку», «Оновлено»), caller hint and error; `package` shows «1 заняття з пакета» with the brand icon and a lock                                                                                                                                                                                                                                                                                               | Lesson forms                                     | `Shared/Form/PriceField`                                                                                                                                             |
