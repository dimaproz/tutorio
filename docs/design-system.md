...
| Direction pass art                       | `TicketArt`, `ReceiptArt`, `CoinsArt`, `PausedArt` — `@/components/shared/pass-art`                                                                                                                                                            | inline SVG drawn in `currentColor` (the caller's tone colours it), `className`; no currency glyph                                                                                                                                                                                                                                                                                                                                                                                            | Student profile passes; packages (S07) and the group page (S08) next | `Students/Screens/Learning`                                                                                                                                          |
