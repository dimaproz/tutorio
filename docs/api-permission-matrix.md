...
| Students         | `GET`, `POST /students`; `GET /students/summary`; `GET`, `PATCH`, `DELETE /students/:studentId`; `GET /students/:studentId/billing`; `POST /students/:studentId/restore`; `DELETE /students/:studentId/permanently`                                                                                                         |
| Parents          | `GET`, `POST /parents`; `GET`, `PATCH`, `DELETE /parents/:parentId`                                                                                                                                                                                                                                                         |
| Teacher profiles | `GET`, `POST /teachers`; `GET`, `PATCH`, `DELETE /teachers/:teacherId`; `GET /teachers/:teacherId/summary`; `GET /teachers/:teacherId/students`; `POST /teachers/:teacherId/archive/preview`; `POST /teachers/:teacherId/archive`; `POST /teachers/:teacherId/restore`                                                      |
...
| Lessons          | `GET`, `POST /lessons`; `GET /lessons/list`; `GET`, `PATCH`, `DELETE /lessons/:lessonId`; `PATCH /lessons/:lessonId/reschedule`; `PATCH /lessons/:lessonId/status`; `POST /lessons/:lessonId/makeup`; `GET`, `PUT /lessons/:lessonId/attendance`; `POST /lessons/bulk-cancel/preview`; `POST /lessons/bulk-cancel`          |
| Schedules        | `GET`, `POST /schedules`; `POST /schedules/preview`; `GET`, `PATCH /schedules/:scheduleId`; `POST /schedules/:scheduleId/changes/preview`; `POST /schedules/:scheduleId/changes`; `POST /schedules/:scheduleId/stop/preview`; `POST /schedules/:scheduleId/stop`                                                            |
...
| Billing          | `GET /billing/warnings`                                                                                                                                                                                                                                                                                                     |
| Pauses           | `GET`, `POST /pauses`; `GET /pauses/:pauseId`; `POST /pauses/:pauseId/end`                                                                                                                                                                                                                                                  |
| Payments         | `GET`, `POST /payments`                                                                                                                                                                                                                                                                                                     |

There are 90 routed handlers: 5 public, 2 self/session, and 83 owner-only.
