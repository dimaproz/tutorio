...
| [0007](./0007-schedules-per-student-charging-package-credits.md) | Schedules per direction, per-student charging, package credits  | Accepted target; implementation pending |
